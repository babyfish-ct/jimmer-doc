...
> For 2, readers who are interested can check [Native Expressions](../../query/native-sql.mdx).
...
Where the meaning of the `fetcher` parameter has been introduced in [Quick Tour/Fetch Any Shape](../fetch/index.mdx), this article does not repeat it and readers can ignore it.  
