...
For more databases that do not support this, use `case` expressions in [common expressions](./expression.mdx).
:::
...
:::info
All [dynamic join](./dynamic-join/index.md) features are valid for these implicit joins.  
:::
