...
-   Jimmer annotations rather than Jackson annotations are used here, because:  This is not only an adjustment of the serialization framework Jackson, but also a useful adjustment of
    ...
    - [Automatic client/server integration](../../client/index.mdx)
    
    - [DTO language](../../object/view/dto-language.mdx)
...
:::info
[@IdView properties](../advanced/view/id-view.mdx) is advanced mapping content that will be explained later. Readers can skip this section for now and come back later.  
:::  
...
:::info  
[DTO](../../object/view/dto-language.mdx) is advanced mapping content that will be explained later. Readers can skip this section for now and come back later.
:::  
