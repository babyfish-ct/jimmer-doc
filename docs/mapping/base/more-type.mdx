...
:::info
Enum types are not discussed in this article, please refer to [Enum Mapping](../advanced/enum.mdx)
:::
...
Jimmer's SQL DSL can mix in Native SQL expressions, please see [Native Expressions](../../query/native-sql.mdx), this article will not repeat it. Note:
...
Please refer to [ScalarProvider](../../configuration/scala-provider.mdx), this article will not repeat it.