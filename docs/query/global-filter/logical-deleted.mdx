...
The mapping related to logical deletion is introduced in great detail in [Mapping / Advanced Mapping / Logical Deletion](../../mapping/advanced/logical-deleted/entity.mdx), so all the details are not repeated here, just a brief recap:
