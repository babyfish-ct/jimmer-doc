...
Reference links: [Dynamism](../object/dynamic.mdx), [Immutability](../object/immutable/index.md)
...
Reference links: [DTO language](../object/view/dto-language.mdx)
...
-   It can handle not only associated properties but also [complex calculated properties](../mapping/advanced/calculated/transient.mdx).
...
-   Entities support [remote associations](../spring/spring-cloud.mdx), i.e., ORM associations across microservice boundaries, with Jimmer automatically querying data from different microservices and assembling it into a single data structure.
...
|Link|Description|
|---|---|
|[Quick Preview/Query Any Shape](../quick-view/fetch/index.mdx)|Quick preview: Query any shape|
...
|Link|Description|
|---|---|
|[Quick Preview/Query Any Shape](../quick-view/save/index.md)|Quick preview: Save any shape|
...
|Link|Description|
|---|---|
|[Quick Preview/Query Any Shape](../quick-view/dsl/index.md)|Quick preview: Arbitrary dynamic queries|
|[Dynamic Table Join](../query/dynamic-join/index.md)||
|[Implicit Subquery](../query/implicit-subquery.mdx)||
|[Intelligent Paging](../query/paging/index.md)|Not shown in this article|
|[Native Expression](../query/native-sql.mdx)|Not shown in this article, how to embed native SQL fragments in a strongly-typed SQL DSL|
|[Dynamic Ordering](../query/dynamic-order.mdx)|Not shown in this article|
|[Super QBE](../query/super_qbe.mdx)||
...
Reference link: [Trigger](../mutation/trigger.mdx)
...
-   Significantly increases the application scope of caching.
    ...
    -   `id->computed result` caching, i.e., <ViewMore buttonText="Calculated Cache"><CalculatedCache/></ViewMore>
        ...
        Calculated caching is designed for [complex computed properties](../mapping/advanced/calculated/transient.mdx), avoiding repeated calculations for multiple queries, which is also very helpful for Jimmer's core functionality of querying data structures of any complexity.
...
Reference link: [Caching](../cache/index.mdx)
...
Reference link: [Global Filter](../query/global-filter/index.md)
...
Reference link: [Interceptor](../mutation/draft-interceptor.mdx)
...
Reference link: [Logical Deletion of Entity Tables](../mapping/advanced/logical-deleted/entity.mdx), [Logical Deletion of Join Tables](../mapping/advanced/logical-deleted/join-table.mdx)

### 3.10. Remote Associations

Jimmer entities support [remote associations](../spring/spring-cloud.mdx), i.e., ORM associations across microservice boundaries.
...
Reference link: [Remote Association Mapping](../mapping/advanced/remote.mdx), [Remote Association Support](../spring/spring-cloud.mdx)
...
When developing with Jimmer, there is a note of caution that needs attention. Please refer to [here](./apt-ksp.mdx#notes)