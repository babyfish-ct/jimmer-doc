...
If you are using Gradle as your build tool, you can also use third-party Gradle plugins provided by the community to automatically identify the project type and add dependencies automatically.
...
plugins {
    ...
    // If your project primarily uses the Kotlin language for development, to ensure this plugin works correctly, you must make sure that your project has applied the KSP plugin.
    // For detailed information of KSP plugin, please refer to “Introduction - APT/KSP”
