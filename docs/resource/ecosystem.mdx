...
| [Intellij Plugin](https://plugins.jetbrains.com/plugin/26622-jimmer-buddy) | [https://github.com/Enaium/JimmerBuddy](https://github.com/Enaium/JimmerBuddy) |
| Any IDE supporting LSP | [https://github.com/Enaium/jimmer-dto-lsp](https://github.com/Enaium/jimmer-dto-lsp) |

:::caution
The three plugins perform the same function and should not be installed simultaneously in Intellij, as this will cause errors.
:::
...
|[Intellij Plugin](https://plugins.jetbrains.com/plugin/26622-jimmer-buddy)|Java & Kotlin|https://github.com/Enaium/JimmerBuddy|
