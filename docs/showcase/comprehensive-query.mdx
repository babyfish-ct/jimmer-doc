...
-   Object Fetcher, i.e. querying arbitrarily shaped data structures, are what are shown in [Fetch Association](./fetch-association/index.md) and [Recursive Query](./recursive-query/index.md).

-   Conditions, especially [Dynamic table join](./where/dynamic-join.mdx) and [Implicit subquery](./where/implicit-subquery.mdx)
