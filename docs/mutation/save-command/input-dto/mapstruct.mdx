...
-   ❶ If the id is designated some auto-generation strategy, it is not required. This is also a feature of save commands, see details in [Save Modes](../save-mode.mdx).
...
How to use the relevant extensions is detailed in [Object/DTO Conversion/MapStruct](../../../object/view/mapstruct.mdx), this article will not repeat it.
...
:::info
MapStruct's annotation processor needs to be used to generate the implementation class for this interface at compile time. Details are explained in [Object Section/DTO Mapping/MapStruct](../../../object/view/mapstruct.mdx) and not repeated here.
:::
