...
-   ❶ If the id is designated some auto-generation strategy, it is not required. This is also a feature of save commands, see details in [Mutation/Save Command/Save Mode/Summary](../save-mode#summary).
