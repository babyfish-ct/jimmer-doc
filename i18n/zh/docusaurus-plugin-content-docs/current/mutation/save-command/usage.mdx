...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <ul>
                    <li>KSqlClient.save</li>
                    <li>KSqlClient.insert</li>
                    <li>KSqlClient.update</li>
                    <li>KSqlClient.merge</li>
                    <li>KSqlClient.append</li>
                </ul>
            </td>
            <td>
                <li>KSqlClient.entities.save</li>
                <li>KSqlClient.entities.saveAll</li>
            </td>
        </tr>
    </tbody>
</table>
