...
[jimmer-examples/kotin/jimmer-cloud-kt/model](https://github.com/babyfish-ct/jimmer-examples/tree/main/kotlin/jimmer-cloud-kt/model))*, define all entity types.
