...
This will be covered in detail in docs about [subqueries](../query/sub-query.mdx).
:::
...
3.  `.exists().not()` can be simplified to `.notExists()` *(exists will be introduced in [subqueries](../query/sub-query.mdx))*
