...
Through the introduction of the [previous article](../feature.mdx), we quickly previewed Jimmer's powerful ability to query arbitrary data structures at will.  
