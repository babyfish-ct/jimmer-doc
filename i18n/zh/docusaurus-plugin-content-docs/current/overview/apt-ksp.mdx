...
-   对于Java而言，就是APT，即[Annotation Processor](https://www.jetbrains.com/help/idea/annotation-processors-support.html)
...
|接受`$`的风格|不接受`$`的风格|
|---|----|
|BookDraft.$.produce|Objects.createBook|
