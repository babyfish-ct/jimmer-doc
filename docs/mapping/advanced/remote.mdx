...
:::caution
Remote association is a product of combining Jimmer with microservice architecture. It will be introduced in detail in [Spring Cloud and Remote Association](../../spring/spring-cloud.mdx).
