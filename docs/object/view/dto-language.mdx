...
can describe DTOs for several entities. See [DTO Composition](./composition) for
...
[Output DTO association configurations](../../query/object-fetcher/dto#association-property-specific-configurations).
...
fragments](./composition). Implementing a Java/Kotlin interface serves a
