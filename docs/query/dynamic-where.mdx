...
We will systematically discuss this in [next doc](./dynamic-join/index.md). 

:::tip
In [next doc](./dynamic-join/index.md) you will see the uniqueness of Jimmer SQL DSL, gaining a powerful capability no other solution in the industry supports.
:::
