...
The community also provides gradle plugins, please refer to [APT/KSP](../../overview/apt-ksp.mdx)
:::
...
See [Spring/Appendix](../../spring/appendix.mdx) for complete documentation on configurations.
