...
This topic has been discussed in detail in [Spring Section/Integrate Spring Transaction](../spring/transaction.mdx). This article will not repeat the explanation.
