...
@`org.babyfish.jimmer.sql.OnDissociate` is used together with [Modification/Save Command](../../mutation/save-command/index.md) and [Modification/Delete Command](../../mutation/delete-command.mdx)

- [Modification/Save Command](../../mutation/save-command/index.md)
...
- [Modification/Delete Command](../../mutation/delete-command.mdx)
...
This article only introduces the configuration of OnDissociate. For how to use it further, please refer to [Save Command/Dissociation Operations](../../mutation/save-command/association/dissociation.mdx) and [Delete Commands](../../mutation/delete-command.mdx).
