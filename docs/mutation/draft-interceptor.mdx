...
Any entity object will be intercepted by interceptors before being [saved by save commands](./save-command/index.md) (whether inserted or updated). 
...
Draft interceptors work with [Save Command](./save-command/index.md) to adjust data before objects are saved.
