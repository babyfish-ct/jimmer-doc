...
As for what these options are used for, please refer to [Query Chapter/DSL Expression/IN LIST/Optimization](../query/expression.mdx#optimization), this article will not repeat it.
:::
