...
1.  Dynamicity
    ...
    See [Dynamic](../../object/dynamic.mdx) for details on dynamicity.
...
2.  Immutability
    ...
    See [Immutability/Solution](../../object/immutable/solution.mdx) for details on how to create and "modify" immutable objects.
