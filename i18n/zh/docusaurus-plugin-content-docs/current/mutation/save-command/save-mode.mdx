...
按照[数据分类](./data-classification)一文所所言，[@Id](../../mapping/base/basic#id)属性被指定的对象叫做Id-specified对象

<Tabs groupId="language">
<TabItem value="java" label="Java">

```java
Book book1 = Immutables.createBook(draft -> {
    draft.setId(20L);
...
Book book2 = Immutables.createBook(draft -> {
    draft.setId(21L);
...
如果视图既无id也无key的聚合根对象，不同的保存模式对应不同的行为：
