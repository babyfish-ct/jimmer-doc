...
In order to solve the above problem, we can add the [@IdView](../../mapping/advanced/view/id-view.mdx) property for entity interface, namely the associated id property.
...
Please refer [here](../../mapping/advanced/view/id-view.mdx) for more details
:::
