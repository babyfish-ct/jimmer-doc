...
Please refer to [Object/DTO conversion/DTO Language](../../../object/view/dto-language.mdx) to know more.
For reusing input DTOs as association property types and sharing property sets
between input DTOs, see [DTO Composition](../../../object/view/composition.mdx).
...
4.  Edit this file and use DTO language to define various DTO shapes for the Book entity:
    ...
    The specific reasons are elaborated in [Object/DTO conversion/DTO Language](../../../object/view/dto-language.mdx) and not repeated here.
    :::
...
-   ❶ If the id is designated some auto-generation strategy, it is not required. This is also a feature of save commands, see details in [Mutation/Save Command/Save Mode](../save-mode.mdx).
