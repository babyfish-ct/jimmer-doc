...
>   [Multiple data sources](../../configuration/multi-datasources.mdx) require creating multiple global objects. 
...
See [DTO Language/3.2. Input-specific functionalities](../../object/view/dto-language.mdx#32-input-specific-functionalities)
:::
