...
However, since [generate client api](./api.mdx) is provided, this part of the functionality must also be provided to make it a complete solution.
...
This part of the code has been discussed in [Overview/Get Started/Generate Code](../quick-view/get-started/generate-code.mdx), so it won't be repeated here.
:::
