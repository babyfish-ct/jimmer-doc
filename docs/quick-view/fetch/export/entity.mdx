...
If you choose to directly return entities *(rather than the DTO returns in the [next article](./dto.mdx))*, and want to use associated ids, you need to add @IdView properties to the entities first:  
