...
Unlike previous REST services, this example does **not** use [object fetchers](../query/object-fetcher/index.md), returning the simplest orphan objects *(orphan objects contain neither associated properties nor calculated properties)*.  
