...
-   For Jimmer's ORM-style queries, inject [Native SQL](../query/native-sql.mdx) expressions in strongly typed SQL DSL.

## Multiple Data Sources

In the previous sections, we discussed the integration of Spring transactions in the single data source scenario. 
As for multiple data sources, please refer to [this section](../configuration/multi-datasources.mdx).