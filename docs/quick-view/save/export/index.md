...
In [Save Any Shape/Feature Introduction](../feature.mdx), we introduced the powerful data saving capability of Jimmer,  
...
To protect system security, [DTO Language](../../../object/view/dto-language.mdx) needs to be used to define Input DTO.  
